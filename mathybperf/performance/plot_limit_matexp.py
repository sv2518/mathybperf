...
files = ["results/" + name + f"order_{o}/cells_2/" + params + type + "_its.json"
         for o in orders]
...
files = ["flames/" + name + f"order_{o}/cells_2/" + params + type + "_flame.txt"
         for o in orders]
...
if complexities:
    ...
    files = ["results/" + name + f"order_{o}/cells_2/" + params + type + "_slate_flops.txt" for o in orders]
    print(files)
    for i, file in enumerate(files):
        try:
            with open(file, 'r') as txt_file:

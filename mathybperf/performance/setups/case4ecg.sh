...
export QUADS=true
export FLAME=true
export BASEP='gtmg_global_matfree_params_matexpmg_assembledjacobi_cg'
export PERFORMP='gtmg_fully_matfree_params_matexpmg_assembledjacobi_cg'
export SOLTYPE='quadratic'
export PROJECTEXACTSOL="" #--projectexactsol
export CASE='/case4ecg/'
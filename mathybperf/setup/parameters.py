...
# Matrix explicit, iterative hybridization
...
# Hyridization, fully matfree with CG
...
# These are the tests similar to Jacks GTMG test in the Firedrake test suite
...
gtmg_fully_matfree_params_matexpmg_noassembledjacobi_fs0_cg_jacobi_fgmres = {'snes_type': 'ksponly',
                                                                           'mat_type': 'matfree',
                                                                           'ksp_type': 'fgmres',
                                                                           'ksp_rtol': 1.e-9,
                                                                           'ksp_atol': 1e-90,
...
gtmg_fully_matfree_params_fs0_cg_jacobi_fs1_cg_laplacian_jacobi_fgmres_noassembledjacobi = {'snes_type': 'ksponly',
                                                                          'mat_type': 'matfree',
                                                                          'ksp_type': 'fgmres',
                                                                          'ksp_rtol': 1.e-9,
                                                                          'ksp_atol': 1e-90,

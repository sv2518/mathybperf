...
def problem(problem_bag, solver_bag, verification, new=True, project=False):
    ...
    if project:
        ...
        w2.sub(0).project(ufl.grad(exact_sol), solver_parameters={'ksp_rtol': 1.e-5}, form_compiler_parameters=fc1, use_slate_for_inverse=False)
        w2.sub(1).project(exact_sol, solver_parameters={'ksp_rtol': 1.e-5},  form_compiler_parameters=fc2, use_slate_for_inverse=False)
